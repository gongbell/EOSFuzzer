(module
  ...
  (import "env" "__floatunsitf" (func (;15;) (type 5)))
  (import "env" "__fixtfsi" (func (;16;) (type 9)))
  (import "env" "__floatsitf" (func (;17;) (type 5)))
  ...
  (import "env" "set_blockchain_parameters_packed" (func (;25;) (type 5)))
  (import "env" "get_blockchain_parameters_packed" (func (;26;) (type 4)))
  (func (;27;) (type 1))
  ...
  (global (;1;) i32 (i32.const 16864))
  (global (;2;) i32 (i32.const 16864))
  ...
  (elem (i32.const 1) 29)
  (data (i32.const 8192) "goodnoti::apply - \00")
  (data (i32.const 8211) "transfer\00malloc_from_freed was designed to only be called after _heap was completely allocated\00")
  (data (i32.const 8306) "eosio.token\00")
  (data (i32.const 8318) " - end of goodnoti::apply\00")
  (data (i32.const 8344) "transfer called, amount = \00")
  (data (i32.const 8371) "yes\00")
  (data (i32.const 8375) "no\00")
  (data (i32.const 8378) "magnitude of asset amount must be less than 2^62\00")
  (data (i32.const 8427) "invalid symbol name\00")
  (data (i32.const 8447) "read\00")
  (data (i32.const 8452) "get\00"))
